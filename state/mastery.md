...
| GPU Execution Model | 5 | 3 | 2026-09-15 | 历史上能解释Grid及Stream顺序；本轮独立通过一维编号、部分Warp、Block分组边界、Lane及二维组合复测。零基编号曾反复偏一，提示记录保留；尚无本轮分支/同步复测，维持3。见 [[sessions/2026-09-15-thread-index-relearning]] |
...
| CUDA Asynchronous Execution | 5 | 3 | 2026-09-13 | 能解释 eager 立即提交、GPU 异步执行和 CPU 同步等待；历史在 RTX 3090 上完成 CPU 同步计时与 CUDA Event 实验；9月13日重学完成状态判断正确，独立CPU工作不依赖GPU结果的解释经提示修正，R1验收待复核 |
